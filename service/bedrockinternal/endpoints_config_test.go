...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-bedrock-internal.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bedrock-internal.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bedrock-internal.dev",
			expectURL:     aws.String("https://env-bedrock-internal.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-bedrock-internal.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-bedrock-internal.dev",
			expectURL:     aws.String("http://config-bedrock-internal.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-bedrock-internal.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-bedrock-internal.dev",
			clientEndpoint: aws.String("https://client-bedrock-internal.dev"),
			expectURL:      aws.String("https://client-bedrock-internal.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_BEDROCK_INTERNAL", c.envService)
			}
