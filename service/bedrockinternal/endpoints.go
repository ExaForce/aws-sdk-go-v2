...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/bedrockinternal/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_BEDROCK_INTERNAL")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Bedrock Internal", cfg.ConfigSources)
	if found && err == nil {
