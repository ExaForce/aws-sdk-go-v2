...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-apps-auth-control.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-apps-auth-control.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-apps-auth-control.dev",
			expectURL:     aws.String("https://env-apps-auth-control.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-apps-auth-control.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-apps-auth-control.dev",
			expectURL:     aws.String("http://config-apps-auth-control.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-apps-auth-control.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-apps-auth-control.dev",
			clientEndpoint: aws.String("https://client-apps-auth-control.dev"),
			expectURL:      aws.String("https://client-apps-auth-control.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_APPS_AUTH_CONTROL", c.envService)
			}
